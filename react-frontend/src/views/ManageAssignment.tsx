          ...
          <div className="rounded-lg p-6 w-full max-h-fit flex flex-col justify-center">
            <div className="w-full max-w-2xl mx-auto p-5 bg-white rounded-lg shadow-sm text-black">
              ...
              <InfoField
                ...
                value={`${appointmentData.patient_first_name} ${appointmentData.patient_last_name}`}
              />
              ...
              <InfoField
                label="Numer pesel"
                value={appointmentData.patient_pesel}
              />
              <InfoField
                label="Adres"
                value={appointmentData.patient_address}
              />
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p>
                    {appointmentData.doctor_first_name}{" "}
                ...
                <div>
                  ...
                  <p>
                    {new Date(appointmentData.start_date).toLocaleString(
                      "pl-PL",
                      { timeZoneName: "short" }
                    )}
                  </p>
