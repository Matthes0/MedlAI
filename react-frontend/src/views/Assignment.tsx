...
const AppointmentBooking: React.FC = () => {
    ...
    const queryDoctor = useQuery({ queryKey: ['doctor'], queryFn: async () => {
    ...
    const renderStep = () => {
        switch (step) {
            case 1:
                return (
                    <div
                        className="flex flex-col md:flex-row w-full space-y-5 md:space-y-0 md:space-x-5 justify-center">
            ...
            <main className="flex flex-col justify-center items-center w-full max-w-5xl">
                <div className="flex w-full bg-[#F0EFFF] shadow-md rounded-md p-4 md:p-10">
                    <div className="rounded-lg p-4 md:p-6 w-full max-h-fit">
                        ...
                        {renderStep()}
                        <div
                            className="mt-6 flex flex-col-reverse md:flex-row justify-end space-y-4 md:space-y-0 md:space-x-4">
                            {step > 1 && (
                                <button
                                    type="button"
